...
bhasha-test:
	cd packages/bhasha-test && PYTHONPATH=src:../../apps/api ../../apps/api/.venv/bin/pytest -q && PYTHONPATH=src:../../apps/api ../../apps/api/.venv/bin/python3 -m bhasha_test evaluate ../../data/eval_cases/grievance_cases.yaml --output /tmp/janavani-bhasha-test-report.json; true
